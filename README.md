...
5. Após conferir que os dados importados estão corretos, clique no botão  *salvar* do conecta na tela de frequência. **Não se esqueça de que essa ação é necesária para que os lançamento sejam salvos no conecta**.
